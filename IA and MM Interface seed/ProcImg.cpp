...
//---------------------------------------------------------------------------
void TProcImg::SalyPim(Graphics::TBitmap* Bitmap)
{
BYTE *P;
...
int randNum = rand() % 100; //Generar un número aleatorio entre 0 y 99
        if(randNum < 5){ //5% de probabilidad de agregar ruido sal
            P[j*3] = 255; //Componente azul
            P[j*3+1] = 255; //Componente verde
            P[j*3+2] = 255; //Componente roja
        } else if(randNum > 94){ //5% de probabilidad de agregar ruido pimienta
